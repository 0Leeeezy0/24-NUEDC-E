...
static ips200_type_enum         ips200_display_type = IPS200_TYPE_SPI;                  // 定义通信类型，默认SPI单排针
...
static uint16                   ips200_x_max        = 240;                              // 屏幕X轴像素最大值
static uint16                   ips200_y_max        = 320;                              // 屏幕Y轴像素最大值
